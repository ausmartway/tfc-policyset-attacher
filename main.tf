...
resource "tfe_policy_set" "aws-s3-best-practices" {
  ...
  organization  = var.organization
  workspace_ids = value(data.tfe_workspace_ids.aws.ids)
  vcs_repo {
...
resource "tfe_policy_set" "azure-fundational-sentinel-policies" {
  ...
  organization  = var.organization
  workspace_ids = value(data.tfe_workspace_ids.azure.ids)
  vcs_repo {
...
resource "tfe_policy_set" "cis-gcp-fundational-policies" {
  ...
  organization  = var.organization
  workspace_ids = value(data.tfe_workspace_ids.gcp.ids)
  vcs_repo {
